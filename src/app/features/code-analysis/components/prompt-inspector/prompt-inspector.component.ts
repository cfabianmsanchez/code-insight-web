      ...
      <button type="button" class="accordion-toggle" (click)="toggleOpen()">
        <div class="toggle-title">
          ...
          <span class="toggle-sub"
            >Visualiza el contexto exacto generado y enviado al motor de
            IA</span
          >
        </div>
      ...
      <div class="accordion-content" *ngIf="isOpen">
        ...
        <div class="prompt-box">
          <div class="box-header">
            <span class="prompt-type-badge system"
              >System Prompt (system-v1.md)</span
            >
            <button
              type="button"
              class="copy-btn"
              (click)="copyToClipboard(context.systemPrompt)"
            >
              Copiar
            </button>
          </div>
        ...
        <div class="prompt-box">
          <div class="box-header">
            <span class="prompt-type-badge user"
              >User Prompt & Radiografía Factual (analysis-v1.md)</span
            >
            <button
              type="button"
              class="copy-btn"
              (click)="copyToClipboard(context.userPrompt)"
            >
              Copiar
            </button>
          </div>
