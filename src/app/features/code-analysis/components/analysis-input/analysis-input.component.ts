  ...
  template: `
    <div class="input-card glass-card">
      <div class="card-header">
        ...
        <p class="card-subtitle">Ingresa la URL pública de GitHub o sube un paquete comprimido .ZIP</p>
      </div>
      ...
      <form *ngIf="mode === 'GITHUB'" (ngSubmit)="submitGithub()" class="input-form">
        <div class="form-row">
          <div class="form-group flex-2">
            <label class="form-label">URL del repositorio público de GitHub</label>
            <input 
              type="url" 
              class="form-control" 
          ...
          <div class="form-group flex-1">
            <label class="form-label">Identificador del análisis (opcional)</label>
            <input 
              type="text" 
              class="form-control" 
              ...
              [disabled]="loading" />
            <span class="form-help">Se usará como identificador del reporte</span>
          </div>
        </div>
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="btn btn-primary" [disabled]="loading || !githubUrl">
          ...
          <div class="form-group flex-2">
            ...
            <div class="file-dropzone" [class.has-file]="selectedFile">
              ...
              <div class="dropzone-content" *ngIf="!selectedFile">
                ...
                <span class="dropzone-text">Haz clic o arrastra un archivo .ZIP aquí</span>
              </div>
              <div class="file-selected-box" *ngIf="selectedFile">
                ...
                <button type="button" class="btn-change-file" (click)="clearSelectedFile($event)" [disabled]="loading">
                  Cambiar archivo
                </button>
              </div>
            </div>
...
export class AnalysisInputComponent {
  @Input() loading = false;
  @Output() analyzeGithub = new EventEmitter<{ repoUrl: string; projectKey?: string }>();
  @Output() analyzeZip = new EventEmitter<{ file: File; projectKey?: string }>();
