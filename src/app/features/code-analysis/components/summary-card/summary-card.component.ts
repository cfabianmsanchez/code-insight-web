  ...
  template: `
    <div class="summary-container" *ngIf="report">
      ...
      <div class="functional-card glass-card">
        <div class="card-badge">🎯 Resumen Funcional (Propósito del Sistema)</div>
        ...
        <p class="summary-text muted" *ngIf="!report.functionalSummary">
          El resumen funcional se encuentra incluido en el informe completo de IA a continuación.
        </p>
      </div>
      ...
      <div class="metrics-grid">
        ...
        <div class="metric-card glass-card">
          ...
          <div class="metric-content">
            <span class="metric-value">{{ report.componentAnalysis.totalComponents }}</span>
        ...
        <div class="metric-card glass-card">
          ...
          <div class="metric-content">
            <span class="metric-value">{{ report.architectureEvidence.totalStructuralPaths }}</span>
